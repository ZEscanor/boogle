...
const Navbar = ({darkTheme, setDarkTheme}) => {
  return (
    ...
    justify-center items-center border-b dark:border-gray-700 border-gray-200 '>
        <div className='flex 
        justify-between 
        items-center 
        space-x-5 
        w-screen' >
             ...
             dark:bg-white bg-gray-900 text-white border rounded-full px-2 py-1 hover:shadow-lg">
